const vDOM = (function(document, window, undefined) {
  ...
  function vDOM(selector, options) {
    ...
    this.el =
      typeof selector === 'string'
        ...
        : selector;
    this.options = {};
    // merge the passed in options object
    if (typeof Object.assign != 'function') {
      throw new Error(
        '`Object.assign` not currently supported by this browser, perhaps you are missing the polyfill?'
      );
    } else {
      // extend the options
  ...
  vDOM.prototype = {
    ...
    _dispatchEvent: function(name, data, el) {
      var el = typeof el !== 'undefined' ? el : this.el, // optional element to dispatch events from.  Default to `this.el` reference
        customEvent = new CustomEvent(name, { detail: data });
      // dispatch the event
...
const html = (
  <div>
    <h1>Hello World!</h1>
    <p class="bold">This is my paragraph!</p>
    <p class="bold">This is my paragraph!</p>
    <p class="bold">This is my paragraph!</p>
    <p class="bold">This is my paragraph!</p>
